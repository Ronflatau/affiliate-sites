  ...
  return (
    <html lang="en">
      <head>
        ...
        {/* @ts-expect-error impact verification uses non-standard value attr */}
        <meta name="impact-site-verification" value="ec5c5395-32c6-486b-b83e-69aa62d04436" />
        ...
        <footer className="bg-gray-900 text-gray-400 mt-20">
          <div className="max-w-5xl mx-auto px-4 py-12">
            ...
            <div className="border-t border-gray-800 pt-6 text-xs space-y-2">
              ...
              <p style={{ fontSize: '10px', color: '#9ca3af' }}>Impact-Site-Verification: 19947120-b7f0-440a-9a39-387720da9e8f</p>
            </div>
          </div>
        </footer>
